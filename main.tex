...
% Table 2 therefore points to increasing relative supply of tertiary educated while Table 1 shows evidence of stagnating or even declining relative wage premiums. This evidence does not exclude the possibility of supply changes as a primary factor of the relative wage dynamics (as exhaustively examined by Katz and Murphy, 92).
...
%Figure \ref{agg_employ_changes_percentiles} comments on a crucial polarizing behaviour in the CEEC. It shows changes in employment shares for the ISCO-08 occupations skill rank between 2011-2019\footnote{The starting year of the analysis is chosen due to changes in ISCO classification in the EU-SILC dataset.}, it also depicts a locally weighted smoothing regression curve. We can notice a rather diversified behaviour across the CEE countries. Central Europe stands out with a clearly monotonic changes in relative employment and an increasing employment share of high-income occupations. The regression curves in the two remaining regions, on the other hand, are rather flat with small increases around 3rd decile. However, the magnitude of these changes is small and especially the Baltics show a high variance of the estimates in the middle of the distribution. Also note that our results can hide significant heterogeneity inside the countries groups\footnote{This is  visible in Figure \ref{employ_changes_percentiles} with some of the Visegrad countries showing small declines in high income categories and diverse results in case of the Baltics.}
%Last but not least, compared to the US evidence, we again do not see the characteristic U-shape found in \citet{acemoglu2012does} for the 1990s and 2000s US labour market, interpreted as the job polarization.
...
% difference top Fig.3 - Fig.3 does not distinguish skill diffs and is limited to certain periods here we are interested
...
%%%% Fitzenberger's revision - Age
\footnote{Unlike some of the follow-up works on SBTC (CM01...), we do not distinguish age categories (young and old workers), significant part of our motivation, is a different behaviour of simple education premia in most of our groups compared to the original us example which was motivated. In figure \ref{wage_premiums_by_age}, we see mostly parallel movement in both young and old education skill premium. The only regions is ... Investigation of advanced framework can be topic of further research.}   % maybe mention young unemployment compared to southern periphery
%%%% Fitzenberger's revision --end
%%%% Regression results
