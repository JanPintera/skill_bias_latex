...
\toprule
                               &   \textbf{CEE}  & \textbf{CEE - Unions} & \textbf{Visegrad}  \\
\midrule
\textbf{Dep. Variable}         &     logW\textbackslash HL    &        logW\textbackslash HL       &      logW\textbackslash HL      \\
\textbf{No. Observations}      &       118       &          118          &         60         \\
\textbf{Cov. Est.}             &    Unadjusted   &       Unadjusted      &     Unadjusted     \\
\textbf{R-squared}             &      0.9987     &         0.9987        &       0.9946       \\
\textbf{R-Squared (Within)}    &      0.4202     &         0.4223        &       0.6073       \\
\textbf{R-Squared (Between)}   &      1.0000     &         1.0000        &       1.0000       \\
\textbf{R-Squared (Overall)}   &      0.9987     &         0.9987        &       0.9946       \\
\textbf{F-statistic}           &      9083.0     &         8128.9        &       1983.3       \\
\textbf{P-value (F-stat)}      &      0.0000     &         0.0000        &       0.0000       \\
\textbf{=====================} & =============== &    ===============    &  ===============   \\
\textbf{log(H\textbackslash L)}             &     -0.0118     &        -0.0127        &      -0.0136       \\
\textbf{ }                     &    (-2.0334)    &       (-2.1186)       &     (-1.9565)      \\
\textbf{Time}    &     -0.0006     &        -0.0007        &      -0.0006       \\
\textbf{ }                     &    (-1.9696)    &       (-2.0533)       &     (-2.0150)      \\
\textbf{EE}            &      0.4586     &         0.4577        &                    \\
\textbf{ }                     &     (83.955)    &        (80.994)       &                    \\
...
\textbf{No. Observations}        &      118       &          118          &         60         \\
\textbf{Cov. Est.}               &   Unadjusted   &       Unadjusted      &     Unadjusted     \\
\textbf{R-squared}               &     0.4202     &         0.4223        &       0.6073       \\
\textbf{R-Squared (Within)}      &     0.4202     &         0.4223        &       0.6073       \\
\textbf{R-Squared (Between)}     &    -0.0485     &        -12.032        &      -0.0957       \\
\textbf{R-Squared (Overall)}     &    -0.0471     &        -12.070        &      -0.0860       \\
\textbf{F-statistic}             &     39.132     &         26.074        &       41.749       \\
\textbf{P-value (F-stat)}        &     0.0000     &         0.0000        &       0.0000       \\
\textbf{=====================}   &  ============  &      ============     &    ============    \\
\textbf{log(H\textbackslash L)}               &    -0.0118     &        -0.0127        &      -0.0136       \\
\textbf{ }                       &   (-2.0334)    &       (-2.1186)       &     (-1.9565)      \\
